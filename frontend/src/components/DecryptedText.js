 ...
 * - as?: string                (HTML tag to render as, e.g., "h1", "p")
 */
export default function Decrypt({
  ...
  encryptedClassName = '',
  animateOn = 'hover',
  as = 'span', // Default to span if no 'as' prop is provided
  ...props
}) {
  ...
  // Use motion's factory to create the correct component based on the 'as' prop
